  ...
  return (
    <div className="flex flex-col px-3.5 pt-2 pb-20 max-w-md mx-auto select-none">
      ...
      <div className="flex items-center justify-between mb-2.5 px-1">
        <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider font-['Rajdhani',sans-serif]">
          Airdrop Tasks List
        </h3>
      ...
      {/* Task 1: Airdrop Wallet */}
      <div
        id="airdrop-wallet-card"
        className="bg-[#141923] border border-white/10 rounded-2xl p-4 mb-3 shadow-lg flex items-center justify-between transition"
      >
        ...
        <button
          ...
          disabled
          className="px-4 py-2 rounded-xl text-xs font-bold bg-gradient-to-r from-amber-500 to-amber-400 text-black shadow-[0_0_12px_rgba(251,191,36,0.25)] opacity-95 cursor-default select-none flex items-center gap-1.5"
        >
      ...
      <div className="bg-[#121620] border border-amber-500/20 rounded-2xl p-3.5 mb-3 text-xs leading-relaxed flex items-start gap-2.5 shadow-inner">
        ...
        <p className="text-slate-300">
          <strong className="text-amber-400">Wallet connection for allocation:</strong> Wallet connection is coming soon. The snapshot and address binding portal will be enabled prior to the official Token Generation Event (TGE).
        </p>
      </div>

      {/* Task 2: Token Listing & Allocation Distribution (Coming Soon at TGE) */}
      <div className="bg-[#141923]/80 border border-white/10 rounded-2xl p-4 mb-3 shadow-lg">
        <div className="flex items-center justify-between mb-1.5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wide">TGE Distribution</h4>
              <span className="text-sm font-black text-white">Token Allocation & Claim</span>
            </div>
          </div>
        ...
        <span className="text-[11px] text-slate-400 block">Official On-Chain Token Claim Portal</span>
      </div>
